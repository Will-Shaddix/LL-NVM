...
loc_ranges = interleave_addresses(HBM_2000_4H_1x64, 8, 128, 0, '3GiB') # 3GB Local memory spread across 8 HBM Controllers and a DDR channel

for i in range (0,8):
    system.loc_mem_ctrlrs[i].dram = HBM_2000_4H_1x64(range=loc_ranges[2*i], in_addr_map=False, null=True) # why the dram and dram_2?
...
# below this was changed to add nvm
system.far_mem_ctrl.dram = NVM_2400_1x64(range=AddrRange('3GiB'), in_addr_map=False, null=True) # replace DDR4_2400_16x4 with NVM
